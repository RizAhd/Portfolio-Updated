...
export const Resume = () => (
  <section id="resume" className="w-full bg-secondary px-4 py-16 sm:px-6 sm:py-24 md:px-12 md:py-32">
            ...
            {experience.map((item) => (
              ...
              >
                <div className="flex flex-wrap items-baseline justify-between gap-x-2 gap-y-1">
                  <h4 className="text-base font-bold text-foreground sm:text-lg">{item.role}</h4>
