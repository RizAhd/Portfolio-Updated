      ...
      <div className="mx-auto flex w-full max-w-xl flex-col items-center gap-6 sm:gap-8 md:gap-10">
        ...
        >
          <MagnetizeButton
            ...
            particleCount={14}
            spread={90}
            particleClassName="bg-[#25D366]"
            className="gap-2.5 rounded-full bg-[#25D366] px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#1eb858] sm:text-base"
          >
