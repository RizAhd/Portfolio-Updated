...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-280 md:h-380 flex items-center justify-center relative p-2 md:p-20"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-7xl -mt-12 mx-auto h-152 md:h-208 w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl"
    >
